...
var apiErrorSpecs = map[int]apiErrorSpec{
	...
	402: {func() string { return phrases().APIErrorPaymentRequired }, "Payment Required", LogError, ActionConfig, false, false, 0},
	...
	406: {func() string { return phrases().APIErrorNotAcceptable }, "Not Acceptable", LogError, ActionError, false, false, 0},
	407: {func() string { return phrases().APIErrorProxyAuthenticationRequired }, "Proxy Authentication Required", LogError, ActionConfig, false, false, 0},
	...
	411: {func() string { return phrases().APIErrorLengthRequired }, "Length Required", LogError, ActionError, false, false, 0},
	...
	414: {func() string { return phrases().APIErrorURITooLong }, "URI Too Long", LogError, ActionError, false, false, 0},
	415: {func() string { return phrases().APIErrorUnsupportedMediaType }, "Unsupported Media Type", LogError, ActionError, false, false, 0},
	416: {func() string { return phrases().APIErrorRangeNotSatisfiable }, "Range Not Satisfiable", LogError, ActionError, false, false, 0},
	417: {func() string { return phrases().APIErrorExpectationFailed }, "Expectation Failed", LogError, ActionError, false, false, 0},
	418: {func() string { return phrases().APIErrorImATeapot }, "I'm a teapot", LogWarn, ActionError, false, false, 0},
	421: {func() string { return phrases().APIErrorMisdirectedRequest }, "Misdirected Request", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	...
	423: {func() string { return phrases().APIErrorLocked }, "Locked", LogWarn, ActionRetry, true, true, ServerErrorRetryDelay},
	424: {func() string { return phrases().APIErrorFailedDependency }, "Failed Dependency", LogError, ActionError, false, false, 0},
	425: {func() string { return phrases().APIErrorTooEarly }, "Too Early", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	426: {func() string { return phrases().APIErrorUpgradeRequired }, "Upgrade Required", LogError, ActionConfig, false, false, 0},
	...
	505: {func() string { return phrases().APIErrorHTTPVersionNotSupported }, "HTTP Version Not Supported", LogError, ActionError, false, false, 0},
	506: {func() string { return phrases().APIErrorVariantAlsoNegotiates }, "Variant Also Negotiates", LogError, ActionError, false, false, 0},
	...
	509: {func() string { return phrases().APIErrorBandwidthLimitExceeded }, "Bandwidth Limit Exceeded", LogWarn, ActionRetry, true, true, ServerErrorRetryDelay},
	510: {func() string { return phrases().APIErrorNotExtended }, "Not Extended", LogError, ActionError, false, false, 0},
	511: {func() string { return phrases().APIErrorNetworkAuthenticationRequired }, "Network Authentication Required", LogError, ActionConfig, false, false, 0},
	520: {func() string { return phrases().APIErrorWebServerUnknownError }, "Web Server Returned an Unknown Error", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	521: {func() string { return phrases().APIErrorWebServerDown }, "Web Server Is Down", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	522: {func() string { return phrases().APIErrorConnectionTimedOut }, "Connection Timed Out", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	523: {func() string { return phrases().APIErrorOriginUnreachable }, "Origin Is Unreachable", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	524: {func() string { return phrases().APIErrorTimeoutOccurred }, "A Timeout Occurred", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	525: {func() string { return phrases().APIErrorSSLHandshakeFailed }, "SSL Handshake Failed", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
	526: {func() string { return phrases().APIErrorInvalidSSLCertificate }, "Invalid SSL Certificate", LogError, ActionConfig, false, false, 0},
	530: {func() string { return phrases().APIErrorOriginDNSError }, "Origin DNS Error", LogWarn, ActionRetry, true, false, ServerErrorRetryDelay},
}

...
const (
	...
	NotifyOnLogin     NotifyEvent = NotifyEvent(ActionLogin)
	NotifyOnLoginFail NotifyEvent = NotifyEvent(ActionLoginFail)
	NotifyOnLogout    NotifyEvent = NotifyEvent(ActionLogout)
)
